...
use pernixc_semantic::{
    component::derived::ir::model::{self, Erased},
...
pub struct NewTypeErased;

impl<M: term::Model<LifetimeInference = NewTypeErased>> From<NewTypeErased>
    for Lifetime<M>
{
    fn from(inference_variable: NewTypeErased) -> Self {
...
impl term::Model for Model {
    type LifetimeInference = NewTypeErased;
