...
///
/// # Fields
/// - `executor`: Manages the execution of queries through a registry of executors.
...
pub struct Runtime {
    ...
    /// Registry for handling serialization and deserialization.
    pub serde: serde::Registry,
}
