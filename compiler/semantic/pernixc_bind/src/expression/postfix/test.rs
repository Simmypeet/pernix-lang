...
use crate::{
    diagnostic::{
        AmbiguousMethodCall, CannotIndexPastUnpackedTuple, ExpectedStructType,
        ExpectedTuple, ExpressionIsNotCallable, FieldIsNotAccessible,
        FieldNotFound, InvalidCastType, MismatchedArgumentCount,
        MismatchedType, TooLargeTupleIndex, TupleIndexOutOfBOunds,
...
fn adt_method() {
    ...
    // getRefX
    {
        ...
        assert_eq!(reference_of.lifetime, Lifetime::Inference(NewTypeErased));
