//! The stack of scopes used during name resolution and variable
//! declaration
...
pub struct Scope {
    ...
    #[get = "pub"]
    named_binding_points: Vec<NameBindingPoint>,

    /// List of alloca variable declarations created so far in this scope.
    #[get = "pub"]
    variable_declarations: Vec<ID<Alloca>>,
...
impl Scope {
    ...
    pub fn add_variable_declaration(&mut self, alloca_id: ID<Alloca>) {
...
impl Stack {
    ...
    #[must_use]
    pub fn search(&self, name: &str) -> Option<&NameBinding> {
