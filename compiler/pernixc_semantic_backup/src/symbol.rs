...
impl GenericParameters {
    /// Creates a new [`GenericArguments`] that contains the generic parameters
    /// as its arguments.
    #[must_use]
    ...
    /// Creates a new [`Substitution`] that maps all the generic parameters to
    /// itself.
    #[must_use]
...
pub type AdtImplementation =
    ImplementationTemplate<AlgebraicKindID, AdtImplementationData>;
