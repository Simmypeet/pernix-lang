...
///
/// Normally, this is used internally by the unification algorithm. To use the
/// unfication algorithm, use [`unify()`] function.
...
>(
    ...
    *unifier.exisitng = existing_clone.clone();
    ...
    // Hopefully, there's more efficient algorithm for this. Reduce the time
