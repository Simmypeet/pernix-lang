...
use crate::{
    semantic::term::{lifetime::Lifetime, r#type::Type},
    symbol::semantic::Symbolic,
};
...
impl Arbitrary for Constant<Symbolic> {
    type Parameters = (
        Option<BoxedStrategy<Lifetime<Symbolic>>>,
        Option<BoxedStrategy<Type<Symbolic>>>,
    );
    type Strategy = BoxedStrategy<Self>;
