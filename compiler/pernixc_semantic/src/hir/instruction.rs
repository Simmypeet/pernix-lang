...
use super::{
    value::{Address, Value},
    AllocaID, RegisterID, TypeSystem, builder::scope::BlockID,
};
use crate::cfg::{
...
/// Is an additional semantic information for [`Jump`] instruction.
///
/// This is used in various data flow analyses.
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, EnumAsInner, From)]
pub enum JunpSemantic {
    /// The jump instruction is generated by `express` instruction.
    FromExpress(BlockID),
}
...
pub struct Jump {
    ...
    /// Gets the optional semantic information of this jump instruction
    #[get_copy = "pub"]
    pub(super) semantic_info: Option<JunpSemantic>,
}
